...
interface IPartialInterface
  extends Partial<
    Pick<
      IOriginal,
      "a" | "email" | "created_at" | "original_optional" | "undefinable_attr"
    >
  > {}
type IPartialType = Partial<
  Pick<
    IOriginal,
    "b" | "email" | "created_at" | "original_optional" | "undefinable_attr"
  >
>;

namespace IOriginal {
  export interface IPartialInterface
    extends Partial<
      Pick<
        IOriginal,
        "c" | "email" | "created_at" | "original_optional" | "undefinable_attr"
      >
    > {}
  export type IPartialType = Partial<
    Pick<
      IOriginal,
      "d" | "email" | "created_at" | "original_optional" | "undefinable_attr"
    >
  >;
}
