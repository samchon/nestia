...
export namespace index {
    ...
    export const path = (section: string, query: index.Query): string => {
        ...
        return `/api/v3/bbs/${encodeURIComponent(section ?? "null")}/articles${encoded.length ? `?${encoded}` : ""}`;;
    }
}
...
export namespace at {
    ...
    export const path = (section: string, id: string & Format<"uuid">): string => {
        return `/api/v3/bbs/${encodeURIComponent(section ?? "null")}/articles/${encodeURIComponent(id ?? "null")}`;
    }
}
...
export namespace store {
    ...
    export const path = (section: string): string => {
        return `/api/v3/bbs/${encodeURIComponent(section ?? "null")}/articles`;
    }
}
