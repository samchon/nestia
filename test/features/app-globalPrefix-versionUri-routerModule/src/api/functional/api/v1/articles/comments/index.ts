...
export namespace index {
    ...
    export const path = (section: string, articleId: string & Format<"uuid">, query: index.Query): string => {
        ...
        return `/api/v1/${encodeURIComponent(section ?? "null")}/articles/${encodeURIComponent(articleId ?? "null")}/comments${encoded.length ? `?${encoded}` : ""}`;;
    }
}
...
export namespace at {
    ...
    export const path = (section: string, articleId: string & Format<"uuid">, id: string & Format<"uuid">): string => {
        return `/api/v1/${encodeURIComponent(section ?? "null")}/articles/${encodeURIComponent(articleId ?? "null")}/comments/${encodeURIComponent(id ?? "null")}`;
    }
}
...
export namespace store {
    ...
    export const path = (section: string, articleId: string & Format<"uuid">): string => {
        return `/api/v1/${encodeURIComponent(section ?? "null")}/articles/${encodeURIComponent(articleId ?? "null")}/comments`;
    }
}
