...
export namespace index {
  ...
  export const path = (
    ...
    const location: string = `/api/v1/${encodeURIComponent(section ?? "null")}/articles/${encodeURIComponent(articleId ?? "null")}/comments`;
...
export namespace at {
  ...
  export const path = (
    ...
    `/api/v1/${encodeURIComponent(section ?? "null")}/articles/${encodeURIComponent(articleId ?? "null")}/comments/${encodeURIComponent(id ?? "null")}`;
}
...
export namespace store {
  ...
  export const path = (section: string, articleId: string & Format<"uuid">) =>
    `/api/v1/${encodeURIComponent(section ?? "null")}/articles/${encodeURIComponent(articleId ?? "null")}/comments`;
}
