...
export namespace index {
    ...
    export const path = (section: string, articleId: string & Format<"uuid">, query: index.Query) => {
        ...
        const location: string = `/api/v1/${section}/articles/${articleId}/comments`;
...
export namespace at {
    ...
    export const path = (section: string, articleId: string & Format<"uuid">, id: string & Format<"uuid">) => `/api/v1/${section}/articles/${articleId}/comments/${id}`;
}
...
export namespace store {
    ...
    export const path = (section: string, articleId: string & Format<"uuid">) => `/api/v1/${section}/articles/${articleId}/comments`;
}
