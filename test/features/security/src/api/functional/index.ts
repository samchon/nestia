 ...
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
export async function basic(connection: IConnection): Promise<basic.Response> {
...
export namespace basic {
  export type Response = Primitive<IToken>;
...
): Promise<basic_by_comment.Response> {
  return PlainFetcher.fetch(connection, {
...
export async function bearer_by_comment(
  connection: IConnection,
): Promise<bearer_by_comment.Response> {
  return PlainFetcher.fetch(connection, {
...
export async function oauth2_by_comment(
  connection: IConnection,
): Promise<oauth2_by_comment.Response> {
  return PlainFetcher.fetch(connection, {
...
export async function optional_by_comment(
  connection: IConnection,
): Promise<optional_by_comment.Response> {
  return PlainFetcher.fetch(connection, {
