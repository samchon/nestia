 ...
 * @module api.functional.bbs.bbs.articles
 ...
 * @path GET /bbs/bbs/:section/articles
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
...
export namespace index {
    ...
    export const path = (section: string, query: index.Query): string => {
        ...
        return `/bbs/bbs/${encodeURIComponent(section ?? "null")}/articles${encoded.length ? `?${encoded}` : ""}`;;
    }
}

/**
 * @controller BbsArticlesController.at
 * @path GET /bbs/bbs/:section/articles/:id
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
...
export namespace at {
    ...
    export const METADATA = {
        method: "GET",
        path: "/bbs/bbs/:section/articles/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    export const path = (section: string, id: string & Format<"uuid">): string => {
        return `/bbs/bbs/${encodeURIComponent(section ?? "null")}/articles/${encodeURIComponent(id ?? "null")}`;
    }
}
 ...
 * @path POST /bbs/bbs/:section/articles
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
...
export namespace store {
    ...
    export const path = (section: string): string => {
        return `/bbs/bbs/${encodeURIComponent(section ?? "null")}/articles`;
    }
}
 ...
 * @path PUT /bbs/bbs/:section/articles/:id
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
