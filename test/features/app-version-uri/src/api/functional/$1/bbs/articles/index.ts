 ...
 * @module api.functional.$1.bbs.articles
 ...
 * @path GET /1/bbs/:section/articles
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
...
export namespace index {
    ...
    export const path = (section: string, query: index.Query): string => {
        ...
        return `/1/bbs/${encodeURIComponent(section ?? "null")}/articles${encoded.length ? `?${encoded}` : ""}`;;
    }
}

/**
 * @controller BbsArticlesController.at
 * @path GET /1/bbs/:section/articles/:id
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
...
export namespace at {
    ...
    export const METADATA = {
        method: "GET",
        path: "/1/bbs/:section/articles/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    export const path = (section: string, id: string & Format<"uuid">): string => {
        return `/1/bbs/${encodeURIComponent(section ?? "null")}/articles/${encodeURIComponent(id ?? "null")}`;
    }
}