 ...
 * @module api.functional.$2.bbs.articles
 ...
 * @path GET /2/bbs/:section/articles
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
...
export namespace index {
    ...
    export const path = (section: string, query: index.Query): string => {
        ...
        return `/2/bbs/${encodeURIComponent(section ?? "null")}/articles${encoded.length ? `?${encoded}` : ""}`;;
    }
}
 ...
 * @path PUT /2/bbs/:section/articles/:id
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
...
export namespace update {
    ...
    export const METADATA = {
        method: "PUT",
        path: "/2/bbs/:section/articles/:id",
        request: {
            type: "application/json",
            encrypted: false
        },
    ...
    export const path = (section: string, id: string & Format<"uuid">): string => {
        return `/2/bbs/${encodeURIComponent(section ?? "null")}/articles/${encodeURIComponent(id ?? "null")}`;
    }
}