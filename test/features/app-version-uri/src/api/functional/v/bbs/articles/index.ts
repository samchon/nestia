 ...
 * @module api.functional.v.bbs.articles
 ...
 * @path GET /v/bbs/:section/articles
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
...
export namespace index {
    ...
    export const path = (section: string, query: index.Query): string => {
        ...
        return `/v/bbs/${encodeURIComponent(section ?? "null")}/articles${encoded.length ? `?${encoded}` : ""}`;;
    }
}

/**
 * @controller BbsArticlesController.at
 * @path GET /v/bbs/:section/articles/:id
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
...
export namespace at {
    ...
    export const METADATA = {
        method: "GET",
        path: "/v/bbs/:section/articles/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    export const path = (section: string, id: string & Format<"uuid">): string => {
        return `/v/bbs/${encodeURIComponent(section ?? "null")}/articles/${encodeURIComponent(id ?? "null")}`;
    }
}
 ...
 * @path POST /v/bbs/:section/articles
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
...
export namespace store {
    ...
    export const path = (section: string): string => {
        return `/v/bbs/${encodeURIComponent(section ?? "null")}/articles`;
    }
}
 ...
 * @path PUT /v/bbs/:section/articles/:id
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
