...
export namespace index {
    ...
    export const path = (section: string, query: index.Query): string => {
        ...
        return `/api/internal/v1/bbs/${encodeURIComponent(section ?? "null")}/articles${encoded.length ? `?${encoded}` : ""}`;;
    }
}
...
export namespace at {
    ...
    export const path = (section: string, id: string & Format<"uuid">): string => {
        return `/api/internal/v1/bbs/${encodeURIComponent(section ?? "null")}/articles/${encodeURIComponent(id ?? "null")}`;
    }
}