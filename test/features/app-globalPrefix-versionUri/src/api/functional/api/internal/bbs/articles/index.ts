...
export namespace index {
    ...
    export const path = (section: string, query: index.Query): string => {
        ...
        return `/api/internal/bbs/${encodeURIComponent(section ?? "null")}/articles${encoded.length ? `?${encoded}` : ""}`;;
    }
}
...
export namespace store {
    ...
    export const path = (section: string): string => {
        return `/api/internal/bbs/${encodeURIComponent(section ?? "null")}/articles`;
    }
}