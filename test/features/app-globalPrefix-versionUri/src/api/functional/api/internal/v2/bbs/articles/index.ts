...
export namespace index {
    ...
    export const path = (section: string, query: index.Query) => {
        ...
        const location: string = `/api/internal/v2/bbs/${section}/articles`;
...
export namespace update {
    ...
    export const path = (section: string, id: string & Format<"uuid">) => `/api/internal/v2/bbs/${section}/articles/${id}`;
}
