...
export async function get(connection: IConnection): Promise<void> {
    return !!connection.simulate ? get.simulate() : PlainFetcher.fetch(connection, {
        ...get.METADATA,
        path: get.path()
    });
}
export namespace get {
    ...
    const random = (g?: Partial<typia.IRandomGenerator>) => typia.random<void>(g);
    const simulate = (_connection: IConnection): void => {
