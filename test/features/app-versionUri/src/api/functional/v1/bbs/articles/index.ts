 ...
 * @accessor api.functional.v1.bbs.articles.index
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
...
export namespace index {
  ...
  export const path = (section: string, query: Query) => {
    ...
    const location: string = `/v1/bbs/${encodeURIComponent(section?.toString() ?? "null")}/articles`;
 ...
 * @accessor api.functional.v1.bbs.articles.at
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
...
export namespace at {
  ...
  export const path = (section: string, id: string & tags.Format<"uuid">) =>
    `/v1/bbs/${encodeURIComponent(section?.toString() ?? "null")}/articles/${encodeURIComponent(id?.toString() ?? "null")}`;
}
