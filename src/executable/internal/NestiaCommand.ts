...
{
    export function sdk(elements: string[], pure: boolean = true): Promise<void>
    {
        return main
        (
            app => app.sdk(),
    ...
    export function swagger(elements: string[], pure: boolean = true): Promise<void>
    {
        return main
        (
            app => app.swagger(),
        ...
        ): Promise<void>
    {
        ...
        if (fs.existsSync("tsconfig.json") === true)
        {
            ...
            const options: ts.CompilerOptions = JSONC.parse(content).compilerOptions;
