...
export namespace remove
{
    ...
    export function path(section: [object Object], sale_ID: [object Object], articleId: [object Object], commentId: [object Object]): string
    {
        return `/sellers/${section}/sales/${sale_ID}/comments/${articleId}/${commentId}`;
    }
}