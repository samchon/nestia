...
/**
 * NestJS test backend that boots the MCP feature's controllers and mounts
 * the MCP transport at `/mcp` on port 37000. Used by both the wire-level
 * tests and the generated SDK client tests.
 *
