...
export * as partial_interface from "./partial_interface/index";
export * as partial_type from "./partial_type/index";

/**
 * @controller PartialDTOTestController.original
 * @path GET /partial-dto-test/original
 * @accessor api.functional.partial_dto_test.original
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
