...
import api from "@api";
import { IMultipart } from "../../../../features/multipart-form-data/api/structures/IMultipart";
...
export const test_api_multipart = async (
  ...
  await ArrayUtil.asyncRepeat(10, async () => {
    ...
    const result: IMultipart.IContent = await api.functional.multipart_form_data.multipart.post(
      connection,
      {
        title: content.title,
