...
Erases an article from the DB.`,validate:(()=>{const s=i=>typeof i.id=="string"&&b(i.id),p=(i,r,e=!0)=>[typeof i.id=="string"&&(b(i.id)||c(e,{path:r+".id",expected:'string & Format<"uuid">',value:i.id}))||c(e,{path:r+".id",expected:'(string & Format<"uuid">)',value:i.id})].every(t=>t),h=i=>typeof i=="object"&&i!==null&&s(i);let m,c;return i=>{if(h(i)===!1){m=[],c=v(m),((e,t,n=!0)=>(typeof e=="object"&&e!==null||c(!0,{path:t+"",expected:"__type",value:e}))&&p(e,t+"",!0)||c(!0,{path:t+"",expected:"__type",value:e}))(i,"$input",!0);const r=m.length===0;return r?{success:r,data:i}:{success:r,errors:m,data:i}}return{success:!0,data:i}}})()}]},execute:async s=>o[s.function.name](s.arguments)}],config:{locale:u.locale,timezone:u.timezone}});return a.jsx(R,{agent:l})};function O(){const[u,o]=y.useState(""),[l,s]=y.useState("gpt-4o-mini"),[p,h]=y.useState(window.navigator.language),[m,c]=y.useState(!1);return a.jsx("div",{style:{width:"100%",height:"100%",overflow:S?void 0:"auto"},children:m===!0?a.jsx(D,{apiKey:u,model:l,locale:p}):a.jsxs(_,{style:{width:"calc(100% - 60px)",padding:15,margin:15},children:[a.jsx(g,{variant:"h6",children:"BBS A.I. Chatbot"}),a.jsx("br",{}),a.jsx(k,{}),a.jsx("br",{}),"Demonstration of Nestia A.I. Chatbot with TypeScript Controller Class.",a.jsx("br",{}),a.jsx("br",{}),a.jsx(g,{variant:"h6",children:" OpenAI Configuration "}),a.jsx(I,{onChange:i=>o(i.target.value),defaultValue:u,label:"OpenAI API Key",variant:"outlined",placeholder:"Your OpenAI API Key",error:u.length===0}),a.jsx("br",{}),a.jsxs(P,{defaultValue:l,onChange:(i,r)=>s(r),style:{paddingLeft:15},children:[a.jsx(x,{control:a.jsx(j,{}),label:"GPT-4o Mini",value:"gpt-4o-mini"}),a.jsx(x,{control:a.jsx(j,{}),label:"GPT-4o",value:"gpt-4o"})]}),a.jsx("br",{}),a.jsx(g,{variant:"h6",children:" Membership Information "}),a.jsx("br",{}),a.jsx(I,{onChange:i=>h(i.target.value),defaultValue:p,label:"Locale",variant:"outlined",error:p.length===0}),a.jsx("br",{}),a.jsx("br",{}),a.jsx(U,{component:"a",fullWidth:!0,variant:"contained",color:"info",size:"large",disabled:u.length===0||p.length===0,onClick:()=>c(!0),children:"Start A.I. Chatbot"})]})})}C(window.document.getElementById("root")).render(a.jsx(O,{}));
