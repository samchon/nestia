...
// brackets `[name]` for the name. A continued line loses the margin up to the
// tag's text, as TypeScript takes it off, and a default value may hold
// brackets of its own. Other tags keep their one `text` part.
//
