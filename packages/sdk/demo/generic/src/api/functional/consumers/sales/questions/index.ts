...
/**
 * @controller ConsumerSaleQuestionsController.refresh()
 * @path PATCH /consumers/:section/sales/:saleId/questions/refresh
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
...
export namespace refresh
{
    ...
    export const PATH: string = "/consumers/:section/sales/:saleId/questions/refresh";
    export const ENCRYPTED: Fetcher.IEncrypted = {
        request: false,
        response: false,
    };
    ...
    export function path(section: string, saleId: string): string
    {
        return `/consumers/${encodeURIComponent(section)}/sales/${encodeURIComponent(saleId)}/questions/refresh`;
    }
}