...
export namespace store
{
    ...
    export type Output = Primitive<ISaleReview>;
...
/**
 * @controller ConsumerSaleReviewsController.refresh()
 * @path PATCH /consumers/:section/sales/:saleId/reviews/refresh
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
...
export namespace refresh
{
    ...
    export const PATH: string = "/consumers/:section/sales/:saleId/reviews/refresh";
    export const ENCRYPTED: Fetcher.IEncrypted = {
        request: false,
        response: false,
    };
    ...
    export function path(section: string, saleId: string): string
    {
        return `/consumers/${encodeURIComponent(section)}/sales/${encodeURIComponent(saleId)}/reviews/refresh`;
    }
}