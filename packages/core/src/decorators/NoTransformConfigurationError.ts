  ...
  if (NoTransformConfigurationError.throws === true)
    throw new Error(
      [
        ...
        `See https://nestia.io/docs/setup for the full plugin configuration; the Go-backed transform migration walkthrough is at node_modules/@nestia/core/MIGRATION.md.`,
      ].join(" "),
    );
