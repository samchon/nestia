...
Last optional generator: **[Mockup Simulator](/docs/tutorial/simulator)** — your SDK can answer requests with realistic random data, so the frontend can develop before the backend is finished.
