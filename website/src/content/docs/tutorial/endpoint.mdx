...
If that sounds magical, read **[Concepts → Pure TypeScript](/docs/concepts/pure-typescript)** and **[Concepts → AOT Compilation](/docs/concepts/aot)** when you have time. They are short.
