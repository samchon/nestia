...
typia's validators are up to **20,000× faster** than `class-validator` on pathological cases (recursive unions, ultimate type shapes). Typical real-server speedup is **30–100×** — see **[Concepts → Why So Fast](/docs/concepts/why-fast)** for the honest breakdown and methodology.
...
- **[Concepts → Pure TypeScript Types](/docs/concepts/pure-typescript)** — why the type is enough.
