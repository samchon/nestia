...
description: Declare the HTTP error status codes and response shapes a controller method can throw — surfaced in Swagger documents and SDK propagation-mode return types.
---
...
import { IUnprocessableEntity } from "@api/lib/structures/IUnprocessableEntity";
...
export class ExceptionController {
  ...
  @TypedException<IUnprocessableEntity>(428)
...
For reference, [swagger](/docs/swagger) allows to special pattern like `2XX`, `3XX`, `4XX`, `5XX` for status code.
        ...
        "responses": {
          ...
          "428": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/IUnprocessableEntity"
                }
              }
            }
          },
