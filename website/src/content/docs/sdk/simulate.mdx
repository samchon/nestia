...
1. Validate the path parameters, the query, the body, and the `@TypedHeaders()` headers of `connection.headers` against their types (same validator as the real server).
