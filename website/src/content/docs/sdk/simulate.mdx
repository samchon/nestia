...
<Callout type="info">
**New to this feature?** Read **[Tutorial → Mockup Simulator](/tutorial/simulator)** for the friendly walkthrough. This page is the reference.
</Callout>
...
- **[Tutorial → Mockup Simulator](/tutorial/simulator)** — the walkthrough.
