...
<Callout type="info">
**New to this feature?** Read **[Tutorial → Auto E2E Tests](/tutorial/e2e)** for the friendly walkthrough. This page is the reference.
</Callout>
...
- **[Tutorial → Auto E2E Tests](/tutorial/e2e)** — the walkthrough.
