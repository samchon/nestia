...
The SDK generator now avoids requiring a patched TypeScript compiler for this workflow. Keep the alias for local type-checking, then publish the generated package normally.
