...
<Callout type="info">
**New here?** Read **[Tutorial → Generate Your SDK](/docs/tutorial/sdk)** and **[Tutorial → Call Your API](/docs/tutorial/consume)** for the friendly walkthrough. This page is the reference.
</Callout>
...
The map of status codes comes from `@TypedRoute.*` (success) plus every `@TypedException()` on the route. Range matchers (`"4XX"`, `"5XX"`) work the same way. See **[Tutorial → Call Your API → handle errors](/docs/tutorial/consume#4-handle-errors)** for the full pattern.
...
- **[Tutorial → Generate Your SDK](/docs/tutorial/sdk)** — the walkthrough.
