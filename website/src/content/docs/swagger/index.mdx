...
<Callout type="info">
**New here?** Read **[Tutorial → Generate Swagger](/tutorial/swagger)** for the walkthrough. This page is the reference.
</Callout>
...
- **[Tutorial → Generate Swagger](/tutorial/swagger)** — the walkthrough.
