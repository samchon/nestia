...
description: Write JSDoc comments and `typia` tag types once — Nestia propagates them into Swagger summaries, DTO schemas, and LLM function-calling application definitions.
---
