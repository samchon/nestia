...
Now Swagger UI shows a 400 response with the `IBadRequest` schema and your description. If you also turned on **propagation mode** ([previous chapter](/tutorial/consume#4-handle-errors)) the SDK gives you the same `IBadRequest` type on the client.

---

## Next

Documentation done. Now the regression net: **[Auto E2E Tests](/tutorial/e2e)** — one command writes an e2e suite for every endpoint.
