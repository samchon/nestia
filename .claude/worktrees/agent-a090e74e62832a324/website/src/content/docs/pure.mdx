...
description: Drop the triple-duplicated `class-validator` and `@nestjs/swagger` decorators — Nestia derives validation and schema directly from pure TypeScript `interface` types.
---
